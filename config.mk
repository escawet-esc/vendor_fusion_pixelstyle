...
ifeq ($(TARGET_BOOT_ANIMATION_RES),1080)
    ...
    ifeq ($(TARGET_BOOT_ANIMATION_RES),)
        $(warning "InFusionStyle: TARGET_BOOT_ANIMATION_RES is undefined, assuming 1080p")
    else
        $(warning "InFusionStyle: Current bootanimation res is not supported, forcing 1080p")
    endif
    PRODUCT_COPY_FILES += $(LOCAL_PATH)/bootanimation/bootanimation_1080.zip:$(TARGET_COPY_OUT_PRODUCT)/media/bootanimation.zip
endif
